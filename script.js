...
function pixelGenerator() {
  // console.log(pixelBoard.childElementCount)
  // console.log(pixelBoard.innerHTML)
  // console.log(pixelBoard.children[0])
  // for (let i; i < pixelBoard.childElementCount; i += 1) {
...
boardSize.addEventListener("blur", function() {
  ...
  // else {
  //   console.log(boardSize.max)
  //   if (boardSize.value < boardSize.min){
  //     boardSize.value = boardSize.min;
  //   }
  //   if (boardSize.value > boardSize.max){

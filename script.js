...
for (let index = 0; index < paleta.length; index += 1) { // insere a classe selected onde for clicado
  ...
  corAtual.addEventListener('click', function () {
      for (let index = 0; index < paleta.length; index += 1) { // apaga a classe selected de todos
        const removeClasse = paleta[index];
